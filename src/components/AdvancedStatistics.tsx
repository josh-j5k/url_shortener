...
function AdvancedStatistics() {
	return (
		<section className="md:px-36 px-8 py-16 pt-32 bg-gray-200">
			<div className="shadow flex bg-white rounded md:py-2 md:px-6 md:items-center -md:flex-col md:justify-between">
				<div className="-md:border-b -md:p-4 -md:py-3">
					<p className=" text-Dark_Violet">full link</p>
				</div>
				<div className="flex -md:flex-col md:items-center md:gap-6 -md:w-full">
					<div className="-md:p-4 -md:py-3">
						<p className="text-Cyan">shortened link</p>
					</div>
